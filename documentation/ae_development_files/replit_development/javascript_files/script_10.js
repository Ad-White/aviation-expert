...
let gameImageSelection = [
   {gameImageName: 'a 10 thunderbolt', gameImage: 'url(images/a-10-thunderbolt_12019.jpg) no-repeat'},
   {gameImageName: 'apache longbow', gameImage: 'url(images/apache-longbow_mrminibike.jpg) no-repeat'}
 /*  {gameImageName: 'avro vulcan', gameImage: 'url(images/avro-vulcan_neico.jpg) no-repeat background-position: center'},
   {gameImageName: 'black hawk', gameImage: 'url(images/black-hawk_AngieJohnston.jpg) no-repeat background-position: center'},
   {gameImageName: 'blackbird', gameImage: 'url(images/blackbird_wikiImages.jpg) no-repeat background-position: center'},
   {gameImageName: 'chinook', gameImage: 'url(images/chinook_sjr4x4.jpg) no-repeat background-position: center'},
   {gameImageName: 'f 15', gameImage: 'url(images/f-15_Defence-Imagery.jpg) no-repeat background-position: center'},
   {gameImageName: 'f 18 hornet', gameImage: 'url(images/f-18-hornet_Military_Material.jpg) no-repeat background-position: center'},
   {gameImageName: 'f 22 raptor', gameImage: 'url(images/f22-raptor_陆龙.jpg) no-repeat background-position: center'},
   {gameImageName: 'lancaster', gameImage: 'url(images/lancaster_JonPauling.jpg) no-repeat background-position: center'},
   {gameImageName: 'not sure', gameImage: 'url(images/not_sure_english-electric-lightning_Up-Free.jpg) no-repeat background-position: center'},
   {gameImageName: 'osprey', gameImage: 'url(images/osprey_sjr4x4.jpg) no-repeat background-position: center'},
   {gameImageName: 'sea harrier', gameImage: 'url(images/sea_harrier_12019.jpg) no-repeat background-position: center'},
   {gameImageName: 'spitfire', gameImage: 'url(images/spitfire_JonPauling.jpg) no-repeat background-position: center'},
   {gameImageName: 'tornado', gameImage: 'url(images/tornado_StevePortugal.jpg)no-repeat background-position: center'}*/
];
