...
function playGame() {
  ...
  let gameImageSelection = [
    { gameImageName: 'a-10 thunderbolt', gameImage: 'url(images/a-10-thunderbolt_12019.jpg)' },
    { gameImageName: 'apache longbow', gameImage: 'url(images/apache-longbow_mrminibike.jpg)' },
    { gameImageName: 'avro vulcan', gameImage: 'url(images/avro-vulcan_neico.jpg)' },
    { gameImageName: 'black hawk', gameImage: 'url(images/black-hawk_AngieJohnston.jpg)' },
    { gameImageName: 'blackbird', gameImage: 'url(images/blackbird_wikiImages.jpg)' },
    { gameImageName: 'chinook', gameImage: 'url(images/chinook_sjr4x4.jpg)' },
    { gameImageName: 'f-15', gameImage: 'url(images/f-15_Defence-Imagery.jpg)' },
    { gameImageName: 'f-18 hornet', gameImage: 'url(images/f-18-hornet_Military_Material.jpg)' },
    { gameImageName: 'f-22 raptor', gameImage: 'url(images/f22-raptor_陆龙.jpg)' },
    { gameImageName: 'lancaster', gameImage: 'url(images/lancaster_JonPauling.jpg)' },
    { gameImageName: 'not sure', gameImage: 'url(images/not_sure_english-electric-lightning_Up-Free.jpg)' },
    { gameImageName: 'osprey', gameImage: 'url(images/osprey_sjr4x4.jpg)' },
    { gameImageName: 'sea harrier', gameImage: 'url(images/sea_harrier_12019.jpg)' },
    { gameImageName: 'spitfire', gameImage: 'url(images/spitfire_JonPauling.jpg)' },
    { gameImageName: 'tornado', gameImage: 'url(images/tornado_StevePortugal.jpg)' }
  ];
  ...
  function addUserInput() {
    ...
    document.getElementById("userAnswer").innerHTML = `<input type="text" style="font-size: 20px;" id='userInputArea'></input><br><button id="userBtn" class="button">guess / skip</button>`;
  ...
  function updateCurrentLevel() {
    ...
    currentLevel.innerHTML = `<h5>Current Level: ` + `${gameLevel}</h5>`;
